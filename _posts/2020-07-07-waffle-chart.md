...
date: '2020-07-07'
---
Displaying **proportional data**, i.e., subsets of data that contribute to a whole, can be done in various ways. However, two particularly suitable types of visualisations are **isotypes** and **waffle charts**. 
