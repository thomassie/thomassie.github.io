...
date: '2018-01-25'
---
Finally, the first part of my analysis/exploration of [storm data](http://thomassie.de/Storms) from the HURDAT2 data set is online. I was about to write 'done', but actually it's been done for a couple of days. However, I wasn't able to embed all figures when exporting R markdown files with R Studio to .md and .html.
