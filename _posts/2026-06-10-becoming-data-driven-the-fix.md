...
[The first part of this pair](/2026-05-27-becoming-data-driven-the-problem/) ended on a single observation. The recurring failure across data work is a question that was never framed properly. The fix is a habit, and it can be run from either side of the table.
